...
namespace OnlineJobPortal.Admin
{
    public partial class JobList : System.Web.UI.Page
    {
        ...
        private void ShowJob()
        {
            ...
            query = @"Select Row_Number() over(Order by (Select 1)) as [Sr.No], jobID, Title, NoOfPost, Qualification, Experience, Deadline, CompanyName, Addresss, CreateDate from Jobs";
